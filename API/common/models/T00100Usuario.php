 ...
 */
class T00100Usuario extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\T00100UsuarioQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\T00100UsuarioQuery(get_called_class());
    }
}
